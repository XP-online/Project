...
public:
    ...
    void setupUi(QDialog *OBSBasicSettings)
    {
        ...
        formLayout->setWidget(8, QFormLayout::SpanningRole, audioSourceScrollArea);
        ...
        formLayout->setWidget(9, QFormLayout::FieldRole, audioMsg);
        ...
        formLayout->setWidget(10, QFormLayout::FieldRole, audioMsg_2);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 593, 761));
    ...
    void retranslateUi(QDialog *OBSBasicSettings)
    {
        ...
        openStatsOnStartup->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.OpenStatsOnStartup", Q_NULLPTR));
        ...
        groupBox_11->setTitle(QApplication::translate("OBSBasicSettings", "Basic.TogglePreviewProgramMode", Q_NULLPTR));
        doubleClickSwitch->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.SwitchOnDoubleClick", Q_NULLPTR));
        studioPortraitLayout->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.StudioPortraitLayout", Q_NULLPTR));
        label_64->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.General.MultiviewLayout", Q_NULLPTR));
        ...
        advReplayBuf->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.UseReplayBuffer", Q_NULLPTR));
        advReplayBufferGroupBox->setTitle(QApplication::translate("OBSBasicSettings", "ReplayBuffer", Q_NULLPTR));
        advRBSecMaxLabel->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.ReplayBuffer.SecondsMax", Q_NULLPTR));
        advRBHotkeyLabel->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.ReplayBuffer.HotkeyMessage", Q_NULLPTR));
        advRBMegsMax->setSuffix(QApplication::translate("OBSBasicSettings", " MB", Q_NULLPTR));
        advRBMegsMaxLabel->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Output.ReplayBuffer.MegabytesMax", Q_NULLPTR));
        advOutTabs->setTabText(advOutTabs->indexOf(advOutputReplayTab), QApplication::translate("OBSBasicSettings", "ReplayBuffer", Q_NULLPTR));
        ...
        channelSetup->insertItems(0, QStringList()
         ...
         << QApplication::translate("OBSBasicSettings", "2.1", Q_NULLPTR)
         << QApplication::translate("OBSBasicSettings", "4.0", Q_NULLPTR)
         << QApplication::translate("OBSBasicSettings", "4.1", Q_NULLPTR)
         << QApplication::translate("OBSBasicSettings", "5.1", Q_NULLPTR)
         << QApplication::translate("OBSBasicSettings", "7.1", Q_NULLPTR)
        );
        ...
        label_65->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate", Q_NULLPTR));
        meterDecayRate->clear();
        meterDecayRate->insertItems(0, QStringList()
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Fast", Q_NULLPTR)
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Medium", Q_NULLPTR)
         << QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Slow", Q_NULLPTR)
        );
        meterDecayRate->setCurrentText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Audio.MeterDecayRate.Fast", Q_NULLPTR));
        ...
        disableAudioDucking->setText(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Audio.DisableAudioDucking", Q_NULLPTR));
        ...
        advNetworkGroupBox->setTitle(QApplication::translate("OBSBasicSettings", "Basic.Settings.Advanced.Network", Q_NULLPTR));
